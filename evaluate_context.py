...
if __name__ == "__main__":
    ...
    # args.dataset = "jdd_context"
    # args.model_path = "/tank/local/cgo5577/jdd_context-main/models/whisper_mfcc_mesonet_context_context_ct_seed_1_20241002_134630"
    # args.embedding_path = "/tank/local/cgo5577/jdd_context-main/processed_embeddings/jdd_ct"

    model_prefix = args.model_path.split("/")[-1]
    save_name = f"./results_context/{args.dataset}_{model_prefix}"
    # if os.path.exists(f"./{save_name}.csv"):
    #     raise Exception("Have Tested results")
    ...
    for i, path in enumerate(all_model_paths):
        ...
        time_save_dir = f"./results_context/infer_time_{args.dataset}_{model_prefix}.json"
