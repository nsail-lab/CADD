DATA="./configs/context_in_the_wild" # base_jdd_synthetic base_in_the_wild
DATASET="in_the_wild_context" # "jdd_synthetic" "in_the_wild"
EPOCH=20
for TYPE in "ct" # "c" "t" "ct"
do
  EMBEDDING_PATH="/tank/local/cgo5577/dataset_jdd/DATASETS_ITW_FOR_CHONGYANG/${TYPE}"
