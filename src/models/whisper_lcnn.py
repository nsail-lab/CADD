...
from src.models.lcnn import LCNN, LCNNContext
...
class WhisperMultiFrontLCNN_lfccmfcc(WhisperLCNN):
...
class WhisperLCNNContext(LCNNContext):
...
class WhisperMultiFrontLCNNContext(WhisperLCNNContext):
...
class WhisperMultiFrontLCNNContext_lfccmfcc(WhisperLCNNContext):
