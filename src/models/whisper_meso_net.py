...
from src.models.meso_net import MesoInception4, MesoContext
...
class WhisperMultiFrontMesoNet_lfccmfcc(WhisperMesoNet):
    def __init__(self, freeze_encoder, **kwargs):
        super().__init__(freeze_encoder=freeze_encoder, **kwargs)
...
class WhisperMesoContext(MesoContext):
    def __init__(self, freeze_encoder, **kwargs):
        super().__init__(**kwargs)
...
class WhisperMultiFrontMesoContext(WhisperMesoContext):
    def __init__(self, freeze_encoder, **kwargs):
        super().__init__(freeze_encoder=freeze_encoder, **kwargs)
...
class WhisperMultiFrontMesoContext_lfccmfcc(WhisperMesoContext):
    def __init__(self, freeze_encoder, **kwargs):
        super().__init__(freeze_encoder=freeze_encoder, **kwargs)
